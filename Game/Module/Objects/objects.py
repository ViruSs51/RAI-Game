...
class Object:
    ...
    async def setImages(self, new_images: list = None, new_size: list[int]=None) -> list:
        ...
        resized_images = []
        for img in images:
            resized_images.append(pg.transform.scale(img, self.size if not new_size else new_size))
