...
class Controller(Object):
    ...
    async def getClick(self, button: int, click_range: list[list]=None):
        ...
        return (buttons_status[button] and not click_range) or (buttons_status[button] and click_range[0][0] < mouse_x < click_range[0][1] and click_range[1][0] < mouse_y < click_range[1][1])
