...
class Button(Object):
    ...
    def __init__(
        ...
        font: str = None,
        font_size: int = 36,
        text_colors: list[list[int] | str] = ["black", "black", "white"],
        text_background_colors: list[list[int] | str] = None,
    ...
    def getCenterForText(self):
        return (
            self.pos[0] + self.size[0] / 2 - self.text.text_rect.width / 2,
