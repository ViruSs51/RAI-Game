        ...
        for image_or_folder in folders:
            if image_or_folder.endswith(".png"):
                try:
                    ...
                    print("error")
            elif image_or_folder.endswith((".tmx", ".txt", ".ttf", ".aseprite", ".gif", ".zip")) :
                pass
            else:
...
list = ["character/right_side_perspective/spider_1/run", "character/right_side_perspective/spinner_1", "character/right_side_perspective/swordman_1",
"character/right_side_perspective/viridian_drake_1"
"character/right_side_perspective/wanderer_magican_1",
"character/right_side_perspective/wizard_1",
"character/right_side_perspective/wraith_01",
"character/right_side_perspective/wraith_02",
"character/right_side_perspective/wraith_03",
"character/right_side_perspective/young_brass_dragon_1",
"character/right_side_perspective/young_red_dragon_1","character/right_side_perspective/Stone Troll", "character/right_side_perspective/Swamp Troll" "character/up_perspective/", "objects/", "tiles/"]
for foler in list:
